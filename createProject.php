...
// Status 
$query_status = "SELECT * FROM status WHERE tipo = 'project'";
                ...
                <div class="row">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="project_title" placeholder="Type the title here">
                            <small id="emailHelp" class="form-text text-muted">Please, use few words.</small>
                        </div>
                        <div class="form-group">
                            <label for="project_description">Description</label>
                            <input type="text" class="form-control" id="project_description" placeholder="Type the description here">
                        </div>
                        <div class="form-group">
...
<script>
    ...
    $("#create").click(function() {
        ...
        $.ajax({
            url: "create_Project.php?login="      +login

                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="createUser.php?login=<?php echo $login; ?>">Create</a>
                                    </li>
                                    <li>
                                        <a href="usersList.php?login=<?php echo $login; ?>">List</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="createProject.php?login=<?php echo $login; ?>">Create</a>
                                    </li>
                                    <li>
                ...
                <div class="row">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="users_login" placeholder="Type the login here">
                            <small id="emailHelp" class="form-text text-muted">Use the first name "dot" last name.</small>
                        </div>
                        <div class="form-group">
                            <label for="users_password">Password</label>
                            <input type="password" class="form-control" id="users_password" placeholder="Type the password here">
                            <small id="emailHelp" class="form-text text-muted">Use at least 8 letters and 1 number.</small>
                        </div>
                        <div class="form-group">
                            <label for="users_profile">Profile</label>
                            <br>
                            <select id="users_profile">
                                <option></option>
...
<script>
    ...
    $("#create").click(function() {
        ...
        var users_profile = document.getElementById("users_profile").value;
        var login = document.getElementById("login").value;

        $.ajax({
            url: "create_User.php?login="             +login
                                    +"&login_criado=" +users_login
                                    +"&senha="        +users_password
                                    +"&perfil="       +users_profile
        });
